...
const rabbitMQUrl = 'amqp://rabbitmq:oK3SV4UrC4DdnxF@20.244.98.222'; // URL to your RabbitMQ server with authentication
const queue = 'job1'; // Name of the RabbitMQ queue
